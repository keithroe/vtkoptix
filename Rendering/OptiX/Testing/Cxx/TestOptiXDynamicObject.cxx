/*=========================================================================
  ...
  Module:    TestOptiXDynamicObject.cxx
...
int TestOptiXDynamicObject(int vtkNotUsed(argc), char* vtkNotUsed(argv)[])
{
  ...
  vtkSmartPointer<vtkOptiXPass> ospray=vtkSmartPointer<vtkOptiXPass>::New();
